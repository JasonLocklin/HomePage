...
\item
 ...
 \begin{innerlist}
  \item
    \href{https://freeknowledge.wordpress.com/2012/10/02/asterisk-home-pbx/}{Asterisk
    home phone PBX system}
  \item
    MythTV Network PVR and XBMC based
  ...
  \item
    \href{http://wp.me/p6Esq-35}{Antennas} for portable amateur
    satellite and repeater use.
  \item
    \href{http://freeknowledge.wordpress.com/2012/10/02/bluetooth-tnc/}{Bluetooth
    TNC} (modem) for wireless connection between handheld radio and
